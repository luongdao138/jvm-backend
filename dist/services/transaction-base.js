...
var TransactionBaseService = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.transactionManager_) return [3, 2];
                        doWork = function (m) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        error_3 = _a.sent();
                                        if (!errorHandler) return [3, 7];
                                        queryRunner = this.transactionManager_.queryRunner;
                                        if (!(queryRunner && queryRunner.isTransactionActive)) return [3, 5];
                                        return [4, queryRunner.rollbackTransaction()];
                                    case 4:
                                        _a.sent();
                                        _a.label = 5;
                                    case 5: return [4, errorHandler(error_3)];
                                    case 6:
                                        _a.sent();
                                        _a.label = 7;
                        ...
                        return [4, doWork(this.transactionManager_)];
                    ...
                    case 2:
                        ...
                        if (!(isolation && this.manager_)) return [3, 10];
                        result = void 0;
                        _a.label = 3;
                    case 3:
                        _a.trys.push([3, 5, , 10]);
                        return [4, this.manager_.transaction(isolation, function (m) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2, doWork_1(m)];
                            }); }); })];
                    case 4:
                        result = _a.sent();
                    ...
                    case 5:
                        error_1 = _a.sent();
                        if (!this.shouldRetryTransaction_(error_1)) return [3, 6];
                        return [2, this.manager_.transaction(isolation, function (m) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2, doWork_1(m)];
                            }); }); })];
                    case 6:
                        if (!errorHandler) return [3, 8];
                        return [4, errorHandler(error_1)];
                    case 7:
                        _a.sent();
                        _a.label = 8;
                    ...
                    case 10:
                        ...
                        return [4, this.manager_.transaction(function (m) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2, doWork_1(m)];
                            }); }); })];
                    case 11: return [2, _a.sent()];
                    case 12:
                        error_2 = _a.sent();
                        if (!errorHandler) return [3, 14];
                        return [4, errorHandler(error_2)];
                    case 13:
                        result = _a.sent();
                        if (dontFail) {
                            return [2, result];
