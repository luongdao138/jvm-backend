...
function default_1(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var redisClient, error_1, client;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (!configModule.projectConfig.redis_url) return [3, 5];
                    redisClient = new ioredis_1.default(configModule.projectConfig.redis_url, {
                        lazyConnect: true,
                    });
                    _b.label = 1;
                case 1:
                ...
                case 3:
                    error_1 = _b.sent();
                    logger.error("An error occur while connect to Redis: ".concat(os_1.EOL, " ").concat(error_1));
                    return [3, 4];
                case 4:
                    container.register({
                        redisClient: (0, awilix_1.asValue)(redisClient),
                    });
                    return [3, 6];
                case 5:
                    if (isProduction) {
...
//# sourceMappingURL=redis-loader.js.map