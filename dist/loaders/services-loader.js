                    ...
                    return [4, Promise.all(core.map(function (modulePath) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        loaded = (_b = (_c.sent())) === null || _b === void 0 ? void 0 : _b.default;
                                        if (!loaded)
                                            return [2];
                                        name = (0, format_registration_name_1.default)(modulePath);
                                        container.register((_a = {},
                                            _a[name] = (0, awilix_1.asFunction)(function (cradle) {
